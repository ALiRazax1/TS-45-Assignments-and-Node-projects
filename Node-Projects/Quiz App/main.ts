...
const quiz = [
  ...
  new questions(
    "q4",
    "Which symbol is used for type assertion in TypeScript?",
    ["A) ->", "B) :", "C) <>", "D) ::"],
    "C) <>"
  ),
  new questions(
    "q5",
    "What does 'tsc' stand for in TypeScript?",
    [
  ...
  new questions(
    "q6",
    "Which operator is used for optional chaining in TypeScript?",
    ["A) ..", "B) ?.", "C) !!", "D) ~~"],
    "B) ?."
  ),
  new questions(
  ...
  new questions(
    "q8",
    "How do you define a function in TypeScript with optional parameters?",
    [
  ...
  new questions(
    "q10",
    "What is the purpose of the private keyword in TypeScript?",
    [
...
console.log(`                       ${chalk.greenBright.bold.green(
  `Welcome in our quiz app`
)}

        ${chalk.bold.redBright(
          `You will have to answer 10 questions about "Typescript"`
        )}`);
