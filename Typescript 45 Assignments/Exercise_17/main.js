...
let Guest = ["Khizar", "Hasan", "Anas", "Bilal", "Hassan"];
for (let i = 0; i < Guest.length; i++) {
    console.log(`Hi ${Guest[i]} come to my house tonight for dinner it will be a great pleasure for me`);
}
...
console.log("Sorry fiends the dinner table didn't arrive so I have to invite only two guests");
